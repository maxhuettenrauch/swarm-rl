...
from swarm_zoo.point_envs.rendezvous import NearestNeighborGraphObsWrapper
...
def train():
    ...
    eval_env = NearestNeighborGraphObsWrapper(eval_env, max_observed_agents=5)
    ...
    model = PPO(
        ActorCriticMessagePassingPolicy,
        env,
